package com.example.firebase_recyclerview_data;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void submit(View view) {
        ...
        DocumentReference documentReference = firebaseFirestore.collection("DataRecycler").document("" + mobileStr);
    ...
    private void AddData(String nameStr, String mailStr, String mobileStr, String genderStr, String stateStr) {
        ...
        firebaseFirestore.collection("DataRecycler").document("" + mobileStr).set(map, SetOptions.merge()).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
